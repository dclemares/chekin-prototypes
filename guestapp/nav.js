...
(function () {
  ...
  var PAGES = [
    ...
    { group: 'AI Travel Guide', items: [
      { file: 'flow-travel-guide-mobile.html', label: 'AI Travel Guide — mobile', icon: '📱', subs: [
      ...
      { file: 'flow-travel-guide-desktop.html', label: 'AI Travel Guide — desktop', icon: '🖥', subs: [
        { hash: 'tgd-intro', label: 'Intro' },
        { hash: 'tgd-q1', label: 'Step 1 · Trip style' },
        { hash: 'tgd-q2', label: 'Step 2 · Budget' },
        { hash: 'tgd-q3', label: 'Step 3 · Pace' },
        { hash: 'tgd-q4', label: 'Step 4 · Interests' },
        { hash: 'tgd-q5', label: 'Step 5 · Places' },
        { hash: 'tgd-q6', label: 'Step 6 · Avoid + build' },
