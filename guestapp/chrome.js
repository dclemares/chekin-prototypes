...
(function () {
  ...
  var GROUPS = [
    ...
    { label: 'Your stay', items: [
      ...
      /* Last in the group because it ends the stay — the flow itself gates on
         the check-out date, the rail just knows where it lives. */
      { id: 'checkout',   icon: 'i-door-open', label: 'Check-out', href: 'flow-checkout-desktop.html#cd-leave' },
    ]},
  ...
  var SYMBOLS = {
    ...
    'i-door-open': '<path d="M11 20H2"/><path d="M11 4.562v16.157a1 1 0 0 1-1.242.97L5 20V5.562a2 2 0 0 1 1.515-1.94l4-1A2 2 0 0 1 11 4.562Z"/><path d="M11 4h3a2 2 0 0 1 2 2v14"/><path d="M14 12h.01"/><path d="M22 20h-3"/>',
